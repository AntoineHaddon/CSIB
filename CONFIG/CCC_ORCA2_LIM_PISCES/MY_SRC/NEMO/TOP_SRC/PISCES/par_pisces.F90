MODULE par_pisces
   ...
   INTEGER, PUBLIC, PARAMETER ::   jp_pisces     =  24     !: number of passive tracers
   ...
   INTEGER, PUBLIC, PARAMETER ::   jpori = jp_lp + 24    !: Clone of NO3
   ...
   INTEGER, PUBLIC, PARAMETER ::   jpori = jp_lp + 25    !: Clone of NO3 
