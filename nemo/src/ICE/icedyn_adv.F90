MODULE icedyn_adv
   ...
   USE trcsms_csib , ONLY : icedia_gca, iceno3_gca, icenh4_gca     ! ice BGC tracers
   !
   ...
   SUBROUTINE ice_dyn_adv( kt ) 
      ...
      CASE( np_advPRA )                ! PRATHER scheme        !
         ...
         CALL ice_dyn_adv_pra(         kt, u_ice, v_ice, h_i, h_s, h_ip, &
            &                          ato_i, v_i, v_s, sv_i, oa_i, a_i, a_ip, v_ip, v_il, e_s, e_i, icedia_gca, iceno3_gca, icenh4_gca )
      END SELECT
