...
# endif
      ...
      !<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
!DBG
if (kstp == nit000) CALL dia_wri_state_noice( 'out.state0.before_sbc.in.stp', kstp )
                         CALL sbc    ( kstp )         ! Sea Boundary Condition (including sea-ice)
!DBG
if (kstp == nit000) CALL dia_wri_state( 'out.state1.after_sbc.in.stp', kstp )
...
!DBG
if (kstp == nit000) CALL dia_wri_state( 'out.state1.after_bdy_dta.in.stp', kstp )
...
!DBG
if (kstp == nit000) CALL dia_wri_state( 'out.state1.after_zdf_mxl.in.stp', kstp )
