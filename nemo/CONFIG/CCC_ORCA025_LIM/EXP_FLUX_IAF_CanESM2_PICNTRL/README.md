CCC_ORCA025_LIM/EXP_FLUX_IAF_CanESM2_PICNTRL
============================================

`CCC_ORCA025_LIM` is the CCCma configuration of ORCA0.25
...
SSS was from Levitus. The SST file is missing for ORCA025. In the future
SST and SSS should come from the CanESM2 runs. 
