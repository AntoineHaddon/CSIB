MODULE trcini_pisces
   ...
   USE p4zsed          !  Sedimentation
   USE p4zint          !  Temperature-dependence
   ...
   REAL(wp) :: bioma0 =  1.000e-2_wp  
   REAL(wp) :: no3    =  31.04_wp
 
#  include "top_substitute.h90"
   !!----------------------------------------------------------------------
   !! NEMO/TOP 3.3 , NEMO Consortium (2010)
   !! $Id: trcini_pisces.F90 3295 2012-01-30 15:49:07Z cetlod $ 
...
CONTAINS
   ...
   SUBROUTINE trc_ini_pisces
      ...
      CALL p4z_int_init       !  temperature dependence of biological rates
