MODULE par_pisces
   ...
   !!           CMOC1  !  2013-15  (O. Riche)           key_pisces only mode
   !!----------------------------------------------------------------------
   ...
   INTEGER, PUBLIC, PARAMETER ::   jp_pisces     =  8      !: CMOC1 tracers
   ...
   INTEGER, PUBLIC, PARAMETER ::   jppoc = jp_lp +  4    !
   INTEGER, PUBLIC, PARAMETER ::   jpphy = jp_lp +  5    !
   INTEGER, PUBLIC, PARAMETER ::   jpzoo = jp_lp +  6    !
