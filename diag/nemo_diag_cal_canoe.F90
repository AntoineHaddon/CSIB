MODULE nemo_diag_cal_canoe
   ...
   !! 2019-03 (J. Christian): biogeochemistry (CanOE) version
   !!---------------------------------------------------------------
   !!
   !!---------------------------------------------------------------
   ...
   !!---------------------------------------------------------------
   USE nemo_diag_glovars_canoe

   IMPLICIT NONE
   PRIVATE      
   PUBLIC cmip6_co3sat           ! Called by nemo_diag_canoe.F90
   PUBLIC cmip6_cchem
   PUBLIC cmip6_o2sol
...
END MODULE nemo_diag_cal_canoe
