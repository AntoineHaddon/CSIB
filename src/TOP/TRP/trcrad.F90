...
CONTAINS
   ...
   SUBROUTINE trc_rad( kt )
      ...
      IF( ln_cmoc    )   CALL trc_rad_sms( kt, trb, trn, 1, jp_bgc + jp_cmoc,  cpreserv='Y' )  !  CMOC CanBGC model
      IF( ln_canoe   )   CALL trc_rad_sms( kt, trb, trn, 1, jp_bgc + jp_canoe, cpreserv='Y' )  !  CanOE CanBGC model
